 ...
 */
class GetFlightPricesInteractor(val flightPricesRepository : FlightPricesRepository) : Interactor {
    ...
    override fun invoke(): Event {
        ...
        val flightPrices = flightPricesRepository.getFlightPrices(this.cabinClass, this.country, this.currency, this.locale, this.locationSchema, this.originPlace, this.destinationPlace, outboundDate, inboundDate, this.adults, this.children, this.infants, this.pageIndex, this.pageSize)
